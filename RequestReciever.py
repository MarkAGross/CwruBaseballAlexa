...
class receiver:
    ...
    def __init__(self, inputstring):
        ...
        self.keywordspart = ["name", "position", "bats and throws", "height", "weight", "weigh", "year", "hometown and high school", "hometown", "high school", "games played", "at bats", "runs", "hits", "doubles", "triples", "home runs", "runs batted in", "walks", "strikeouts", "stolen bases", "batting average", "on base percentage", "slugging percentage", "appearances", "game starts", "wins", "losses", "saves", "complete games", "innings pitched", "strikeouts per nine innings", "strikeouts per 9 innings", "earned runs", "earned run average"] 
        self.keywordssched = ["next game", "previous game"]
        self.data = []
        self.inputstring = inputstring
        self.tosend = [len(self.keywords)]
        self.tosendpart = [len(self.keywordspart)]
        self.tosendsched = [len(self.keywordssched)]
